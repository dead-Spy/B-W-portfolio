...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'Collaborating with Tanvir on multiple projects has been a true pleasure. His exceptional skills, attention to detail, and commitment to quality consistently made him an invaluable asset to the team.',
    ...
    {
      quote:
        'Working with Tanvir has been an exceptional experience. His invaluable support, dedication, and professionalism were crucial in bringing my project to life. Thank you, Tanvir',
      author: 'Esmail Atta',
      position: 'Founder of xon',
